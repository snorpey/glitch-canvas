...
(function (window, factory) {
	...
	// create two canvases and contexts
	...
	function checkType(it, name, expected_type) {
		if ((typeof it === 'undefined' ? 'undefined' : _typeof(it)) === expected_type) {
			return true;
		} else {
			error(it, 'typeof ' + name, '"' + expected_type + '"', '"' + (typeof it === 'undefined' ? 'undefined' : _typeof(it)) + '"');
			return false;
		}
	}
