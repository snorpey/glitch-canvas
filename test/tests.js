...
describe(
	...
	function ()
	{
		...
		function glitchWithoutImageData() { glitch( undefined, parameters, callback ); }
		function glitchWithEmptyImageData() { glitch( { width: 0, height: 0, data: [ ] }, parameters, callback ); }
		function glitchWithoutParameters() { glitch( image_data, undefined, callback ); }
		function glitchWithoutCallback() { glitch( image_data, parameters ); }
		function glitchWithEmptyParameters() { glitch( image_data, { }, callback ); }
		function glitchCorrectly() { glitch( image_data, parameters, callback ); }
		...
		it(
			'adds a global glitch function named "glitch"',
			function ()
			{
		...
		it(
			"throws an error if no parameters are given",
			function ()
			{
		...
		it(
			"throws an error if the image_data argument is not undefined",
			function ()
			{
		...
		it(
			"throws an error if the image_data argument is empty",
			function ()
			{
		...
		it(
			"throws an error if the parameters argument is undefined",
			function ()
			{
		...
		it(
			"doesn't throw an error if the parameters argument is empty",
			function ()
			{
		...
		it(
			"throws an error if the callback argument is not undefined",
			function ()
			{
		...
		it(
			"doesn't throw an error with correct arguments",
			function ()
			{
		...
		it(
			"does pass a valid imageData object to callback function",
			function ( done )
			{
				glitch(
					image_data,
					parameters,
					function( glitched_image_data )
					{
						checkAsync(
							done,
							function()
							{
								...
								expect( typeof glitched_image_data.data.length ).to.equal( 'number' );
								expect( glitched_image_data.data.length ).to.equal( image_data.data.length );
							}
						);
					}
				);
